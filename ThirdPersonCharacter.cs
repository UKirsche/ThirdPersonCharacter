...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : ThirdPersonNPC, IMovablePlayer, IUpdateAnimatorJump, IUpdateAnimatorCrouch
	{
		...
		public void updateAnimatorTurn ()
		{
			m_Animator.SetFloat ("Turn", m_TurnAmount, 0.1f, Time.deltaTime);
		}

		public void updateAnimatorCrouch ()
		{
			m_Animator.SetBool ("Crouch", m_Crouching);
		}

		public void updateAnimatorGround ()
		{
		...
		public void UpdateAnimatorDragLeg ()
		{
		...
		/// <summary>
		/// Calculates the drag leg.
		/// </summary>
		void CalculateDragLeg ()
		{
			if (!m_IsGrounded) {
				updateAnimatorJump ();
			}
			if (m_IsGrounded) {
				UpdateAnimatorDragLeg ();
			}
		}
		...
		new void UpdateAnimator(Vector3 move)
		{
			// update the animator parameters
			updateAnimatorMove ();
			updateAnimatorTurn ();
			updateAnimatorCrouch ();
			updateAnimatorGround ();
			CalculateDragLeg ();
